...
/// @brief  Inicializa cada direccion del array. Setea isEmpty en TRUE
///
/// @param arr -> array de direcciones
/// @param len -> longitud del array
/// @return Retorna (0) en caso de exito, (-1) en caso de error
int inicializarDirecciones(Direccion arr[], int len);


/// @brief Busca el indice de la primera direccion encontrada que tenga la propiedad isEmpty en TRUE
///
/// @param arr -> array de direcciones
/// @param len -> longitud del array
/// @return retorna el indice del asociado en caso de encontrarlo. Si no (-1)
int buscarEspacioLibreDireccion(Direccion arr[], int len);


/// @brief Busca el indice de la direccion mediante un id
///
/// @param arr -> array de direcciones
/// @param id -> id de la direccion
/// @param len -> longitud del array
/// @return -> En caso de encontrarlo devuelve el indice, en caso de no encontrarlo (-1)
int buscarDireccionPorId(Direccion arr[], int id, int len);
...
/// @brief Elimina una direccion del array
///
/// @param arr -> array de direcciones
/// @param id -> id de la direccion a eliminar
/// @param len -> longitud del array
/// @return En caso de exito (0), en caso de error (-1)
int eliminarDireccion(Direccion arr[], int id, int len);
...
/// @brief Verifica si al menos hay 1 direccion
///
/// @param arr -> array de direcciones
/// @param len -> longitud del array
/// @return En caso de haber al menos un asociado TRUE (1), sino FALSE (0)
int hayDireccionCargada(Direccion arr[], int len);


/// @brief Verifica si existe o no la direccion en base al id proporcionado
///
/// @param arr -> array de direcciones
/// @param len -> longitud del array
/// @param id -> id de la direccion a verificar su existencia
/// @return En caso de existir devuelve TRUE (1), en caso contraro FALSE (0)
int existeDireccion(Direccion arr[], int len, int id);
